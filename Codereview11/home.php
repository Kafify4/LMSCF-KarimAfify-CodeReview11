...
<title>Welcome to our Adoptioncenter!<?php echo $userRow['userName']; ?></title>
<style>
body{
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      <li class="nav-item active">
        <a style="color:indianred;" class="nav-link" href="home.php">All Animals<span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
