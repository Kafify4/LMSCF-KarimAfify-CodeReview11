...
<title>Welcome to our Juniors Feed<?php echo $userRow['userName']; ?></title>
<style>
  body{
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a style="color:dodgerblue;" class="nav-link" href="senior.php">Senior Animals</a>
      </li>
      <li class="nav-item">
        <a style="color:indianred;" class="nav-link" href="general.php">Junior Animals</a>
      </li>
    </ul>
    <form id='formData' class="form-inline my-2 my-lg-0">
     ...
     <a  href="logout.php?logout">Sign Out</a> 
            ...
            <h2 style="color:dodgerblue;" align='center'>Our Juniors(Under 8 years old)</h2>
